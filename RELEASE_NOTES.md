...
- Replace Jest and Babel with Node's test runner and strict TypeScript compilation. The suite contains 268 tests; local source coverage is 98.84% of lines.
...
Publishing through GitHub Actions is manual. The Release workflow accepts an existing stable version tag and reruns the full test matrix before publishing. Pushes and tags only trigger validation.
